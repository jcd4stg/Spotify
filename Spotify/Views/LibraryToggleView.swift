...
//  Spotify
//
//  Created by lynnguyen on 06/02/2024.
//
...
class LibraryToggleView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        playlistButton.addTarget(self, action: #selector(self.didTapPlaylists), for: .touchUpInside)
        albumButton.addTarget(self, action: #selector(self.didTapAlbums), for: .touchUpInside)
